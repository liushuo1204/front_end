module.exports =
    ...
    /** *** */ __webpack_require__.t = function (value, mode) {
        ...
        /** *** */
        if (mode & 2 && typeof value !== 'string') for (const key in value) __webpack_require__.d(ns, key, function (key) {
            return value[key]
        }.bind(null, key))
        /** *** */
        return ns
            ...
            methods: {
                ...
                _modelChange: function _modelChange(newVal, oldVal, path) {
                    ...
                    if (diffObj) {
                        (function () {
                            ...
                            _this.triggerEvent(isValid ? 'success' : 'fail', isValid ? {trigger: 'change'} : {
                                errors,
                                trigger: 'change'
                            })
                        }())
                ...
                validate: function validate(cb) {
                    ...
                    return this.formValidator.validate(function (isValid, errors) {
                        ...
                        _this2.triggerEvent(isValid ? 'success' : 'fail', isValid ? {trigger: 'validate'} : {
                            errors: handleError,
                            trigger: 'validate'
                        })
                ...
                validateField: function validateField(name, value) {
                    ...
                    return this.formValidator.validateField(name, value, function (isValid, errors) {
                        ...
                        _this3.triggerEvent(isValid ? 'success' : 'fail', isValid ? {trigger: 'validate'} : {
                            errors: handleError,
                            trigger: 'validate'
                        })
                        cb && cb(isValid, handleError)
